...
all_rooms = [wc_room, kitchen_room, bedroom_room, livingroom_room, outside]

all_doors = [door_wc, door_bedroom, door_livingroom, door_kitchen]

# define which items/rooms are related

object_relations = {
    "living room": [couch, piano, door_wc],
    "bedroom": [bed, mirror, table],
    "piano": [key_wc],
    "outside": [door_wc],
    "door wc": [wc_room, outside]
}
...
def play_room(room):
    ...
    if(game_state["current_room"] == game_state["target_room"]):
        ...
        print_slow("You are now in " + room["name"])
